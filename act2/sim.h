...
unsigned int traducir_direccion(unsigned int dv, PageTableEntry *tabla_paginas, Marco *memoria_fisica, int n_marcos, int page_bits, int *puntero_reloj, int *fallo, int verbose);
